<?php
    ...
    $buscar_cadastros = "SELECT * FROM tb_clientes";
    ...
    <div class="container">
        ...
        <tr>
            <form action = "cadastro.php" method="POST">
                ...
                <td><input type="submit" name="cadastro"></td>
            </form>
        </tr>
        <br>
        <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <form action = "excluir.php" method="POST">                   
                            ...
                            <Button type="submit" name="Excluir" style="background-color: red; border-color: red; border-radius: 5px; color: white;">Excluir</Button>
                        </form>
                    </td>                    
                </tr>      
                    <?php }; ?> 
